...
### What's new in Lumi?
1. Support for 1.20.0 – 1.26.50 version (you can set the minimum protocol in the config)
...
3. Write a command to run: `java -jar Lumi-1.6.9.jar`
...
Adding dependency:
```kts
compileOnly("com.koshakmine:Lumi:1.6.9-SNAPSHOT")
```
