...
public interface BlockInternalTags {
    ...
    BlockTag THIN_BLOCK = BlockTags.register("lumi:thin_block", new SimpleBlockTag(
           BlockTypes.GLASS_PANE,
            ...
            BlockTypes.HARD_GLASS_PANE,
            BlockTypes.HARD_WHITE_STAINED_GLASS_PANE,
            BlockTypes.HARD_LIGHT_GRAY_STAINED_GLASS_PANE,
            BlockTypes.HARD_GRAY_STAINED_GLASS_PANE,
            BlockTypes.HARD_BLACK_STAINED_GLASS_PANE,
            BlockTypes.HARD_BROWN_STAINED_GLASS_PANE,
            BlockTypes.HARD_RED_STAINED_GLASS_PANE,
            BlockTypes.HARD_ORANGE_STAINED_GLASS_PANE,
            BlockTypes.HARD_YELLOW_STAINED_GLASS_PANE,
            BlockTypes.HARD_LIME_STAINED_GLASS_PANE,
            BlockTypes.HARD_GREEN_STAINED_GLASS_PANE,
            BlockTypes.HARD_CYAN_STAINED_GLASS_PANE,
            BlockTypes.HARD_LIGHT_BLUE_STAINED_GLASS_PANE,
            BlockTypes.HARD_BLUE_STAINED_GLASS_PANE,
            BlockTypes.HARD_PURPLE_STAINED_GLASS_PANE,
            BlockTypes.HARD_MAGENTA_STAINED_GLASS_PANE,
            BlockTypes.HARD_PINK_STAINED_GLASS_PANE,
